...
<body>
    ...
    <section class="text-center py-5">
        <p class="fs-2 text-center" style="color: var(--bs-gray-300);">About FinanceBuddy</p>
        <p style="text-align: center;margin: 10%;">At Finance Buddy, we believe that financial success is about more than just making money. It's about understanding your financial situation, creating a plan that works for you, and making smart decisions that will help you achieve your long-term goals. Our team of financial advisors and professionals are dedicated to helping you achieve financial security and independence, no matter what challenges you may be facing. We understand that everyone's financial situation is unique, which is why we work with you to create a personalized financial plan that's tailored to your individual needs and goals. Our advisors are available to provide guidance, support, and advice every step of the way, so you can make informed decisions and achieve success. Whether you're looking to save for retirement, pay off debt, invest in the stock market, or achieve any other financial goal, Finance Buddy has the tools, resources, and expertise to help you succeed. Sign up today and let us help you achieve financial freedom and security.</p>
