...
<body>
    ...
    <section class="text-center py-5">
        <p class="fs-2 text-center" style="color: var(--bs-gray-300);">About PersonalBuddy</p>
        <p style="text-align: center;margin: 10%;">Welcome to Personal Buddy, your personal development coach and guide to becoming your best self. Our mission is to help you unlock your full potential, overcome obstacles, and achieve personal growth and success. At Personal Buddy, we believe that personal development is about more than just achieving goals. It's about understanding yourself, your strengths and weaknesses, and your core values. It's about developing self-awareness, self-confidence, and resilience. Our team of personal development coaches and professionals are dedicated to helping you become the best version of yourself. We understand that personal growth can be a challenging and sometimes overwhelming process. That's why we provide you with the tools, resources, and support you need to succeed. Our coaches are available to provide guidance, accountability, and motivation every step of the way, so you can stay on track and achieve success. Whether you're looking to improve your communication skills, develop your leadership abilities, build better relationships, or achieve any other personal goal, Personal Buddy has the expertise, resources, and support to help you succeed. Sign up today and let us help you unlock your full potential and achieve personal growth and success.</p>
        <button class="btn btn-primary" type="button" data-bss-hover-animate="pulse" onclick="redirect();">Complete Profile to Continue</button>
