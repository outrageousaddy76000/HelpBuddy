...
<body>
    ...
    <section class="text-center py-5">
        <p class="fs-2 text-center" style="color: var(--bs-gray-300);">About ExamBuddy</p>
        <p style="text-align: center;margin: 10%;">Welcome to Exam Buddy, your personal exam preparation coach and guide to acing your exams. Our mission is to help you prepare for exams effectively, boost your confidence, and achieve your academic goals. At Exam Buddy, we understand that exams can be stressful and challenging. That's why we provide you with valuable tips, techniques, and strategies that will help you perform at your best. Our team of experienced educators and exam coaches are dedicated to helping you achieve exam success, no matter what subject you're studying. We believe that effective exam preparation is about more than just memorization. It's about understanding the exam format, managing your time effectively, and developing a strategy that works for you. Our coaches are available to provide guidance, support, and motivation every step of the way, so you can stay on track and achieve success. Whether you're preparing for a high-stakes standardized test or a challenging course exam, Exam Buddy has the tools, resources, and expertise to help you succeed. Sign up today and let us help you achieve your academic goals and reach your full potential.</p>
