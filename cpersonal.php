...
<body>
    ...
    <div id="app">
      ...
      <form>
        <textarea name="prompt" rows="1" cols="1" placeholder="Ask Personal Buddy..."></textarea>
        <button class="btn btn-primary" type="submit" data-bss-hover-animate="pulse"><img src="assets/send.svg" alt="send" />
      </form>
    </div>
