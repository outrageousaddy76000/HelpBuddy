    ...
    <section class="py-5">
        ...
        <div class="container py-4 py-xl-5">
            ...
            <div class="row gy-4 row-cols-1 row-cols-md-2 row-cols-xl-3">
                <div class="col">
                    <div class="card"><img class="card-img-top w-100 d-block fit-contain" style="height: 200px;" src="/assets/img/shahil_logo.png">
                ...
                <div class="col text-center">
                    <div class="card"><img class="card-img-top w-100 d-block fit-contain" style="height: 200px;" src="/assets/img/delivery.svg?h=b2ad45aa2c11382ea46aaf914580237e">
                ...
                <div class="col text-center">
                    <div class="card"><img class="card-img-top w-100 d-block fit-contain" style="height: 200px;" src="/assets/img/bbd_logo.png">
                        <div class="card-body p-4">
                    ...
                    </div><a class="btn btn-primary" role="button" data-bss-hover-animate="pulse" href="https://sanu0711.github.io/Bank-Of-Bajarang-Dal/">Visit</a>
                </div>
                <div class="col">
                    <div class="card"><img class="card-img-top w-100 d-block fit-contain" style="height: 200px;" src="/assets/img/rahul_logo.png">
                        <div class="card-body text-center p-4">
