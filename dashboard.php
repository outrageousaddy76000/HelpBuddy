    ...
    <nav class="navbar navbar-dark navbar-expand-md sticky-top py-3" id="mainNav">
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="/"><span class="bs-icon-sm bs-icon-circle bs-icon-primary shadow d-flex justify-content-center align-items-center flash animated me-2 bs-icon" style="background: url(&quot;/assets/img/bot.svg?h=4a1db879f985bc12d967ad91c42b322a&quot;) top / contain;"></span><span data-bss-hover-animate="pulse" style="font-family: papyrus;font-weight: bold;font-style: italic;">HelpBuddy</span></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse text-end mt-auto" id="navcol-1" style="width: 649.156px;">
                ...
                </ul><a class="btn btn-primary shadow" role="button" data-bss-hover-animate="jello" href="dashboard.php">Dashboard</a>
            </div>
        </div>
                        ...
                        <div class="container" id="signup-form">
                            <div class="row mb-5">
                                <div class="col-md-8 col-xl-6 text-center mx-auto">
                                    <h2 id = "cid">Complete Profile</h2>
                                    <p>Complete your HelpBuddy Profile to Proceed</p>
                                </div>
                            </div>
                                    ...
                                    <div class="card mb-5">
                                        <div class="card-body d-flex flex-column align-items-center">
                                            <div class="bs-icon-xl bs-icon-circle bs-icon-primary bs-icon my-4"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-person">
                                                ...
                                                <form class="text-center" method="post" action="cprofile.php">
                                                    <div class="row mb-3">
                                                        <div class="col-md-12">
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-md-6">
                                                            <input class="form-control" type="text" name="fname" placeholder="First Name" maxlength="30" required>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <input class="form-control" type="text" name="lname" placeholder="Last Name" maxlength="30" required>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-3">
                                                        <div class="col-md-6">
                                                        ...
                                                        <div class="col-md-6">
                                                            <select class="form-control" name="gender" required>
                                                                <option value="male" style="background-color: #2d2c38; color: white;">Male</option>
                                                                <option value="female" style="background-color: #2d2c38; color: white;">Female</option>
                                                                <option value="other" style="background-color: #2d2c38; color: white;">Other</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-3">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <button class="btn btn-primary d-block w-100" data-bss-hover-animate="pulse" type="submit" name="cprofile" value="Complete Profile">Submit</button>
                                                        </div>
                                                    </div>
                                                </form>
                                                <br />
                                                <p class="text-muted">Use Another Account? <a href="signup.php" onclick='destroySession()'>Sign Up</a></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
