...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/Inter.css?h=f35991706a4e501411f201ed67d7e0be">
    <link rel="stylesheet" href="/assets/css/Lora.css?h=8021ea6d22da08b6c8c211668c1585a9">
...
<section class="py-5">
  <ul class="nav nav-tabs d-flex justify-content-center" style="align-items:center">
    <li class="nav-item" style="width: 25%; text-align: center;"><a class="nav-link" href="#0" onclick="changedoc('hbd')" style="color: var(--bs-nav-tabs-border-color);">Health Buddy</a></li>
    <li class="nav-item" style="width: 25%; text-align: center;"><a class="nav-link" href="#0" onclick="changedoc('fbd')" style="color: var(--bs-nav-tabs-border-color);">Finance Buddy</a></li>
    <li class="nav-item" style="width: 25%; text-align: center;"><a class="nav-link" href="#0" onclick="changedoc('pbd')" style="color: var(--bs-nav-tabs-border-color);">Personal Buddy</a></li>
    <li class="nav-item" style="width: 25%; text-align: center;"><a class="nav-link" href="#0" onclick="changedoc('ebd')" style="color: var(--bs-nav-tabs-border-color);">Exam Buddy</a></li>
  </ul>
</section>
<!-- End: Newsletter Subscription Color -->
    <section class ="doccontainer" style="margin-left:2%;display:none" id="hbd">
        <details style="margin-bottom:15px">
            <summary>What is HealthBuddy?</summary>
            <p>HealthBuddy gives you access to personalized health plans and resources to help you achieve your health goals. Whether you're looking to lose weight, quit smoking, or manage a chronic condition, our team of experts will work with you to develop a plan that's tailored to your needs.</p>
        </details>
        <details style="margin-bottom:15px">
            <summary>How do I access HealthBuddy?</summary>
            <p>To access HealthBuddy, simply sign in to your Help Buddy account and navigate to your dashboard. From there, you can unlock HealthBuddy by purchasing any package that includes this feature. To do this, simply click on the "Unlock Now" button next to HealthBuddy in your dashboard, and follow the prompts to complete your purchase. Once you've unlocked HealthBuddy, you'll have full access to HealthBuddy</p>
        </details>
        <details style="margin-bottom:15px">
            <summary>What kind of resources does Health Buddy offer?</summary>
            <p>Health Buddy offers a wide range of resources to help you achieve your health goals. These include personalized health plans, exercise and nutrition guides, wellness tips, and more. Our team of experts will work with you to develop a plan that's tailored to your individual needs, so you can make sustainable changes to your health and well-being.</p>
        </details>
        <details style="margin-bottom:15px">
            <summary>How often are Health Buddy resources updated?</summary>
            <p>We are constantly updating Health Buddy with new resources and information to help you stay on top of your health goals. Our team of experts stays up-to-date with the latest research and trends in health and wellness, so you can be sure that you're getting the most effective advice possible.</p>
        </details>
    </section>
    <section class ="doccontainer" style="margin-left:2%;display:none" id="fbd">
        <details style="margin-bottom:15px">
            <summary>What is FinanceBuddy?</summary>
            <p>FinanceBuddy provides you with financial planning and investment advice to help you manage your money effectively. From budgeting and saving to investing and retirement planning, our financial experts will guide you every step of the way.</p>
        </details>
        <details style="margin-bottom:15px">
            <summary>How do I access FinanceBuddy?</summary>
            <p>To access FinanceBuddy, simply sign in to your Help Buddy account and navigate to your dashboard. From there, you can unlock FinanceBuddy by purchasing any package that includes this feature. To do this, simply click on the "Unlock Now" button next to FinanceBuddy in your dashboard, and follow the prompts to complete your purchase. Once you've unlocked FinanceBuddy, you'll have full access to FinanceBuddy</p>
        </details>
        <details style="margin-bottom:15px">
            <summary>What kind of advice does Finance Buddy offer?</summary>
            <p>Finance Buddy offers personalized financial planning and investment advice to help you manage your money effectively. Our team of financial experts will work with you to develop a plan that's tailored to your individual needs and goals. Whether you're looking to save for a big purchase, invest for retirement, or get out of debt, Finance Buddy can help you make informed decisions about your finances.</p>
        </details>
        <details style="margin-bottom:15px">
            <summary>How often are Finance Buddy resources updated?</summary>
            <p>We are constantly updating Finance Buddy with new resources and information to help you stay on top of your finances. Our team of experts stays up-to-date with the latest trends and developments in the financial world, so you can be sure that you're getting the most effective advice possible.</p>
        </details>
    </section>
    <section class ="doccontainer" style="margin-left:2%;display:none" id="pbd">
        <details style="margin-bottom:15px">
            <summary>What is PersonalBuddy?</summary>
            <p>PersonalBuddy gives you access to a personal coach who will work with you to achieve your personal and professional goals. Whether you're looking to improve your relationships, advance your career, or find more fulfillment in your life, our coaches will help you set and achieve your goals.</p>
        </details>
        <details style="margin-bottom:15px">
            <summary>How do I access PersonalBuddy?</summary>
            <p>To access PersonalBuddy, simply sign in to your Help Buddy account and navigate to your dashboard. From there, you can unlock PersonalBuddy by purchasing any package that includes this feature. To do this, simply click on the "Unlock Now" button next to PersonalBuddy in your dashboard, and follow the prompts to complete your purchase. Once you've unlocked PersonalBuddy, you'll have full access to PersonalBuddy</p>
        </details>
        <details style="margin-bottom:15px">
            <summary>What kind of coaching does Your Personal Buddy offer?</summary>
            <p>Your Personal Buddy offers personalized coaching to help you achieve your personal and professional goals. Our team of coaches will work with you to set and achieve goals related to relationships, career advancement, personal growth, and more. Your Personal Buddy is here to provide guidance, support, and accountability every step of the way.</p>
        </details>
        <details style="margin-bottom:15px">
            <summary>How often are Your Personal Buddy resources updated?</summary>
            <p>We are constantly updating Your Personal Buddy with new resources and information to help you achieve your goals. Our team of coaches stays up-to-date with the latest research and trends in personal and professional development, so you can be sure that you're getting the most effective advice possible.</p>
        </details>
    </section>
    <section class ="doccontainer" style="margin-left:2%;display:none" id="ebd">
        <details style="margin-bottom:15px">
            <summary>What is ExamBuddy?</summary>
            <p>ExamBuddy is designed to help you prepare for exams by giving you valuable tips and strategies on how to do well. Our team of experts has researched and compiled a list of the most effective study techniques and test-taking strategies that you can use to improve your performance on any exam.</p>
        </details>
        <details style="margin-bottom:15px">
            <summary>How do I access ExamBuddy?</summary>
            <p>To access ExamBuddy, simply sign in to your Help Buddy account and navigate to your dashboard. From there, you can unlock ExamBuddy by purchasing any package that includes this feature. To do this, simply click on the "Unlock Now" button next to ExamBuddy in your dashboard, and follow the prompts to complete your purchase. Once you've unlocked ExamBuddy, you'll have full access to our exam preparation tips and strategies.</p>
        </details>
        <details style="margin-bottom:15px">
            <summary>What kind of tips and strategies does ExamBuddy offer?</summary>
            <p>ExamBuddy offers a wide range of tips and strategies to help you prepare for exams. These include subject-related tips, study techniques, test-taking strategies, time management advice, stress reduction techniques, and more. Our team of experts has researched and compiled the most effective methods for improving exam performance, so you can feel confident and prepared on exam day.</p>
        </details>
        <details style="margin-bottom:15px">
            <summary>Can ExamBuddy guarantee that I'll do well on my exams?</summary>
            <p>While we can't guarantee specific exam outcomes, ExamBuddy is designed to help you improve your performance and increase your chances of success. By following our tips and strategies, you'll be better prepared and more confident on exam day.</p>
        </details>
    </section>
    <h2 id="choose-service-message" style="margin-bottom:100px;margin-top: 60px;text-align: center;" >Choose a Service</h2>
